...
| -E \<dias\>               | Configura o numero de dias para a expiração da conta. Depois disso não será mais possível usar essa conta, até que isso seja revertido. |
| -I (i maiusculo) \<dias\> |                                                              |
| -I                        |                                                              |
| -M \<dias\>               | Indica a quantidade máxima de dias que um usuário terá para mudar a senha, ou seja, ele vai ter X dias para mudar a senha, depois disso ele terá que mudar.<br />Um valor de 0 faz com que possa trocar a qualquer momento. |
