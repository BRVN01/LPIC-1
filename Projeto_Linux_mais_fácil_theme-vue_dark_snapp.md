...
<span style="color:#FFFFFF">**;**</span> - O ponto e vírgula executam tudo que vier depois dele, não importa se o comando anterior foi bem ou mal executado (<span style="color:#FFFFFF">pwd ; echo "O comando PWD funcionou"</span> e <span style="color:#FFFFFF">arquivo ; echo "O comando arquivo não funcionou"</span>);
...
## <span style="color:#d86c00">**LS**</span>
...
### <span style="color:#d86c00">**TEE**</span>
...
### <span style="color:#d86c00">**Erro Padrão (stderr - 2)**</span>
...
## <span style="color:#d86c00">**Meios de redirecionar**</span>
...
# <span style="color:#d86c00">**103.5 Criar, monitorar e eliminar processos**</span>
...
## <span style="color:#d86c00">**PS**</span>
...
## <span style="color:#d86c00">**PSTREE**</span>
...
## <span style="color:#d86c00">**PGREP**</span>
...
linux:/tmp\$ pgrep firefox
2066

# Exibindo o PPID do bash:
linux:/tmp\$ pgrep bash
8028
21362
23261
23280
...
linux:/tmp\$ pgrep -u linux bash
21362
```



## <span style="color:#d86c00">**TOP**</span>
...
linux:/tmp\$ top -b -d 2 -n 2 -u linux
...
## <span style="color:#d86c00">**KILL, KILLALL, PKILL**</span>

Comandos usados para matar processos.



### <span style="color:#d86c00">**KILL**</span>
...
linux:/tmp\$ kill -9 25867 25737

# Matando o PPID (Processo pai do Tmux client):
linux:/tmp\$ kill -15 25720
```



### <span style="color:#d86c00">**KILLALL**</span>
...
linux:/tmp\$ killall "tmux: client"

# Matando realmente o tmux (elimina todos os processos relacionados ao tmux):
linux:/tmp\$ killall "tmux: server"

# Matando o processo top:
linux:/tmp\$ killall -9 top

# Para ver o nome de um comando:
linux:/tmp\$ ps -Ao user,pid,tt,comm | grep ^linux
